 ...
 function ApropSmart() {
    return (
        <div>
            <h1> About Us</h1>
            <h4> WHAT WE DO ?</h4>
            <p> SmartTech gives you a chance to quickly and easily find the phone you want and have it delivered to your home in no time, regardless of your location, as long as it is in one of the countries of the EU.</p>
